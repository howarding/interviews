...
//
//Example 2:
//    Input: inputs = ["TimeMap","set","set","get","get","get","get","get"], inputs = [[],["love","high",10],["love",
//      "low",20],["love",5],["love",10],["love",15],["love",20],["love",25]]
...
public:
    ...
    string get(string key, int timestamp) {
        ...
        return right < 0 ? "" : values[right].first;
    }
};
